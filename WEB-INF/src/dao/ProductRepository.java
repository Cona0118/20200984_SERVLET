...
public class ProductRepository {
	...
	public ProductRepository() {
		Product LOL = new Product("LOL", "리그오브레전드", "FREE");
		...
		Product ER = new Product("ER", "이터널리턴", "FREE");
		...
		Product VLRT = new Product("VLRT", "발로란트", "FREE");
        ...
        Product DTD = new Product("DTD", "데이브 더 다이버", "₩24,000");
        ...
        Product DND = new Product("DND", "다크 앤 다커", "$35.00");
        ...
        Product LOA = new Product("LOA", "로스트 아크", "FREE");
