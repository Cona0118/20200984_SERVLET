...
<body>
	...
	<div class="container">
        <form name="newProduct" action="product_add_process.jsp" class="form-horizontal" method="post" enctype ="multipart/form-data">
			...
			<div class="form-group row">
				<label class="col-sm-2">게임 가격</label>
				<div class="col-sm-3">
			...
			<div class="form-group row">
				<label class="col-sm-2">유저 수</label>
				<div class="col-sm-3">
					<input type="text" id ="userInGame" name="userInGame" class="form-control" >
				</div>
			</div>
			<!-- <div class="form-group row">
